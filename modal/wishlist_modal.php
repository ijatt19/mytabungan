...
<div class="modal fade" id="tambahWishlistModal" tabindex="-1" aria-labelledby="tambahWishlistModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-4 border-0">
            <form action="index.php" method="POST">
                <input type="hidden" name="action" value="add">
                <div class="modal-header border-0">
                    <h1 class="modal-title fs-5" id="tambahWishlistModalLabel">Tambah Impian Baru</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="nama_barang" class="form-label">Nama Impian</label>
                        <input type="text" class="form-control form-control-modern" id="nama_barang" name="nama_barang" placeholder="Contoh: Laptop Baru" required>
                    </div>
                    <div class="mb-3">
                        <label for="harga" class="form-label">Target Harga</label>
                        <div class="input-group">
                            <span class="input-group-text">Rp</span>
                            <input type="number" class="form-control form-control-modern" id="harga" name="harga" placeholder="0" required min="0">
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="prioritas" class="form-label">Prioritas</label>
                        <select class="form-select form-control-modern" id="prioritas" name="prioritas" required>
                ...
                <div class="modal-footer border-0">
                    ...
                    <button type="submit" class="btn btn-primary rounded-3">Simpan Impian</button>
                </div>
            </form>
        </div>
    </div>
